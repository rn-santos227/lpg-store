export default function PartnerSection() {
  return (
    <section
      id="partners"
      className="rounded-3xl border border-amber-200 bg-white p-8"
    >
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <a
            className="rounded-full border border-amber-200 bg-white px-5 py-2 text-sm font-semibold text-red-700 transition hover:border-red-300"
